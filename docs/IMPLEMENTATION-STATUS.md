...
| 167 | Automated logic/reliability tests | Partial — 661 frontend and 88 Workers tests (2026-09-16) plus the existing browser flows; the new Track/To-Do/search/intent suites are unit-level only and their Playwright specs await a first CI run; media-source health, provider and device matrices outstanding |
