...
export function NotificationBell({
  ...
  return (
    <button
      ...
      data-slot="notification-bell"
      className={cn(
        "relative grid place-items-center rounded-full outline-none transition-transform active:scale-90 focus-visible:ring-2 focus-visible:ring-gray-500 motion-reduce:active:scale-100",
        SURFACE,
        GLYPH,
        className,
      )}
