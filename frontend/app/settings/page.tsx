    ...
    <div className="py-6 space-y-4">
      ...
      <div className="p-4 bg-gray-900 border border-gray-700 rounded-xl space-y-2">
        ...
        <p className="text-sm text-gray-400">
          ...
          full AI answers. Key stays in this browser only, never uploaded except to Google with your questions.
        </p>
        <input
          type="password"
          value={apiKey}
        ...
        />
        {apiKey && <p className="text-green-400 text-sm">✓ Key saved — full AI active</p>}
      ...
      <div className="p-4 bg-gray-900 border border-gray-700 rounded-xl space-y-2">
        <div className="font-bold">🎙 My voice (speaker recognition)</div>        <p className="text-sm text-gray-400">
          Enroll once so 2–3 people talking nearby don&apos;t get mixed up with you.
        ...
        <label className="flex justify-between items-center gap-2 pt-2 border-t border-gray-800">
          <span className="text-sm">Only answer my enrolled voice
            <span className="block text-xs text-gray-500">Strangers nearby are ignored, not answered. Needs enrollment above.</span>
          </span>
          <input
            type="checkbox"
